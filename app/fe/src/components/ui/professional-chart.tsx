...
export const ProfessionalChart: React.FC<ComponentProps> = ({
  ...
  return (
    <AreaChart id={id} data={data} width={width} height={height}
      ...
      yAxis={<LinearYAxis axisLine={null} tickSeries={showYAxisTicks ? <LinearYAxisTickSeries tickSize={10} label={<LinearXAxisTickLabel fill={themeColors.axisTickColor}/>}/> : <LinearYAxisTickSeries line={null} label={null} tickSize={0}/>}/>}
